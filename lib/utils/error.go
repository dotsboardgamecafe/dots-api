...
var (
	...
	ErrGetUsersPointHistories       = "Error getting user point histories"
	ErrScanUsersPointHistories      = "Error scanning user point histories"
	ErrCountingListUserPointHistory = "Error counting list user point history"
